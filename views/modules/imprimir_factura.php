...
// SEGURIDAD: Solo trabajadores logueados pueden ver o emitir facturas
...
<head>
    ...
    <!-- Importamos Tailwind únicamente para armar la grilla limpia de la hoja blanca -->
...
<body class="p-8 text-slate-800 max-w-3xl mx-auto">
    ...
    <!-- Botón flotante superior de auxilio visual (No saldrá en el PDF/Impresión) -->
    ...
    <!-- Encabezado de Factura Corporativa -->
    ...
    <!-- Bloque de Datos de Cliente de Facturación -->
    ...
    <table class="w-full text-left text-xs border-collapse border border-slate-200 rounded-xl overflow-hidden shadow-sm">
        ...
        <tbody class="divide-y divide-slate-200 font-medium text-slate-700">
            ...
            <!-- Fila de Cierre Financiero Total -->
